...
#' @export
#' @examples x<- read.traps("cameratrapSECR1.txt", detector = "proximity") # assigning your trap data
#' @examples simSECR0(0.003, 200, 0.1, 50, 100, 12, trapD = x) #running your simulations
